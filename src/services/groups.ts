...
async function fetchAllGroupsFromApi(activeRole?: string): Promise<GroupData[]> {
  ...
  const response = await apiFetch(apiUrl('/api/groups'), { headers });
  if (!response.ok) {
...
export async function getGroupById(id: string): Promise<{ groupNumber: number; groupCode: string; projectName: string } | null> {
  try {
    ...
    const res = await apiFetch(apiUrl(`/api/groups/${id}`), {
...
export async function getPublicGroups(
  ...
  try {
    ...
    const response = await apiFetch(apiUrl(`/api/groups/available${query}`));
...
export async function assignSupervisor(
  ...
  const response = await apiFetch(apiUrl(`/api/groups/${groupId}/assign-supervisor`), {
    method: 'POST',
    headers: {
...
export async function updateGroupStatus(
  ...
  const response = await apiFetch(apiUrl(`/api/groups/${groupId}/status`), {
    method: 'PATCH',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
...
export async function deleteGroup(groupId: string): Promise<void> {
  ...
  const response = await apiFetch(apiUrl(`/api/groups/${groupId}`), {
    method: 'DELETE',
    headers: { Authorization: `Bearer ${token}` },
  });
  if (!response.ok) {
...
export async function getGroupsForEvaluation(): Promise<EvaluationGroupsResult> {
  try {
    ...
    const response = await apiFetch(apiUrl('/api/evaluations/groups'), {
      headers: {
        Authorization: `Bearer ${token ?? ''}`,
      },
    });
...
export async function getCoordinatorGroupsWithGrades(
  ...
  try {
    ...
    const response = await apiFetch(apiUrl(`/api/groups/coordinator-grades?courseType=${courseType}`), {
      headers: {
        Authorization: `Bearer ${token ?? ''}`,
...
export async function submitCoordinatorEvaluation(
  ...
  try {
    ...
    const response = await apiFetch(apiUrl(`/api/groups/${groupId}/coordinator-evaluation`), {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Bearer ${token ?? ''}`,
